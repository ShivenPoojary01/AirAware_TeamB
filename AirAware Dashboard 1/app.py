...
# Essential if a frontend running on a different port/domain were to access 
# the API (though Flask serves the HTML directly here, it's good practice for an API).
